...
\newcommand{\resumeItem}[2]{
  ...
  {Software Engineer Technical Lead }{May 2022 -  Feb 2023}
  \resumeItemListStart
  ...
  \resumeItem{Core Feature Designer}{Redesigned key workflows, resulting in a 25\% increase in productivity (measured by decreased time to completion) and a streamlined, user-friendly experience. Worked with Product Owners to optimize workflows based on requirements.}
  \resumeItem{AWS Services Expertise}{Frequently use various AWS services (RDS, DynamoDB, Api Gateway, SQS, Lamda, S3, CloudWatch) }
  \resumeItem{Development Internship Program Director}{Designed and Directed our development internship program. This included: interviewing potential candidates; leading a team of interns to improve a web client, API, infrastructure and CI/CD; and work with project managers and stakeholders to ensure timely delivery}
  ...
  {Designed a Dashboard and Monitor web app from scratch with real-time updates using Websocket and Rxjs, enhancing data representation through the implementation of interactive charts and graphs}
  \resumeItem{Material Design Implementation Specialist}
  {Revamped the look and feel of the company’s following the Material Design Patterns using Styled components, resulting in overall better UI/UX Improved user satisfaction by 90\% with the implementation of intuitive navigation and better visual design elements }
  \resumeItemListEnd
