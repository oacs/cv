...
%-----------SUMMARY-----------------
\section{Summary}
\resumeSummary{Senior Software Developer (5+ years) with a strong background in Web Development using technologies such as Typescript, React.js, and AWS Serverless services. Recognized 9 times for outstanding performance. Founding software engineer at fin-tech startup, contributed to raising \~\$1 million in Series A seed funding and promptly addressed client-facing issues}
